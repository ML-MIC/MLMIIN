...
X0Y1 = pd.DataFrame({'X0' : X0, 'Y' : Y1})
X0Y2 = pd.DataFrame({'X0' : X0, 'Y' : Y2})
X0Y3 = pd.DataFrame({'X0' : X0, 'Y' : Y3})

X0Y1.to_csv("./3_1_simple_linear_regression_01.csv", index=False)
X0Y2.to_csv("./3_1_simple_linear_regression_02.csv", index=False)
X0Y3.to_csv("./3_1_simple_linear_regression_03.csv", index=False)
