...
# 4. Get the Course Setup Files

## 4.1 Clone the course repository
...
# 5. Get and Run the Course Docker Image
...
## 5.1. Get the course Docker image from Docker Hub

In *Terminal* for MacOS o or *PowerShell* for Windows, and **from your course root folder**, run the following command to download the pre-built Docker image for the course from Docker Hub:
...
## 5.2. Command to run the container
...
# 6. Connect from VS Code to the Jupyter Kernel in Docker

## 6.1. Open the course folder in VS Code
...
## Stopping the Jupyter server and Docker container
